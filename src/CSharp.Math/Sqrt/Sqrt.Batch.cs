...
public static partial class HighPerfMath
{
    public static partial class Sqrt
    {
        ...
        public static void ComputeBatchFastInverseSquareRootUnsafe(float[] array)
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                x = ComputeScalarFastInverseSquareRoot(x);
            }
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ComputeBatchInverseSquareRootWithHardwareAcceleration(float[] array)
        {
            ...
            for (; offset < length; offset++)
            {
                ...
                x = ComputeScalarInverseSquareRootWithHardwareAcceleration(x);
            }
        }
    }
}